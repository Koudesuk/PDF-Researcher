...
final_summarize_instructions = """Your goal is to generate a high-quality summary of the web search results and Vector Database information.
...
- DO NOT use any XML-style tags like <think> or <answer>
- Begin directly with the summary text without any tags, prefixes, or meta-commentary
- Mathematical equations formatting requirements:
  * ALL equations MUST be enclosed in LaTeX delimiters
  * Use single "$" for inline equations (e.g., $ E = mc^2 $)
  * Use double "$$" for block/display equations (e.g., $$ \\frac{d}{dx}f(x) = \\lim_{h \\to 0}\\frac{f(x+h)-f(x)}{h} $$)
  * Never leave any mathematical symbols or equations without LaTeX delimiters
  * Ensure proper spacing around "$" and "$$" delimiters
- Language requirements:
  * ALL text MUST be written in Traditional Chinese (繁體中文)
  * This includes:
    - Main content and explanations
    - Technical terms (where appropriate should include English terms in parentheses)
    - Section headings and subheadings
    - Any examples or case studies
  * Never mix Simplified Chinese characters in the output
  * Maintain formal and technical writing style in Traditional Chinese
"""
